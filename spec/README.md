...
7. ~~`spec/00-plan-maintainability-split-modules.md`~~ — 可维护性（尚未创建）
8. ~~`spec/01-plan-api-design.md`~~ — API 设计（尚未创建）
9. ~~`spec/02-plan-performance-cache-lock.md`~~ — 性能（尚未创建）
10. `spec/03-plan-docs-and-examples.md` — 文档与示例：让用户 30 秒上手、5 分钟写对
11. `spec/CODE_REVIEW.md` — 代码审查与改进追踪
